...
//  This project is having a fake advertising data set, indicating whether or not a particular internet user clicked on an Advertisement.
...
var hourlyData = data.withColumn("Hour",hour(data("Timestamp")))
...
var logregdata = (hourlyData.select($"Clicked on Ad".as("label"),
